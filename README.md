...
Delivery Geo Intelligence is a local-first Web GIS proof of concept for personally observed last-mile delivery activity around Eastvale, California. The current application has a two-page frontend shell, a MongoDB-backed Merchant and Delivery API, and server-side stored geocoding with destination coordinate generalization. Maps and analytics are planned for later phases.
